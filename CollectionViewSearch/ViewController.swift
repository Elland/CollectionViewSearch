...
class ViewController: UIViewController, UICollectionViewDataSource
{
    ...
    override func viewDidLoad()
    {
        ...
        self.searchController.searchBar.autoresizingMask = [UIViewAutoresizing.flexibleWidth, UIViewAutoresizing.flexibleHeight]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        if let labelCell = collectionView.dequeueReusableCell(withReuseIdentifier: "LabelCell", for: indexPath) as? LabelCollectionViewCell {
            let labelText = self.data[indexPath.row] as String
